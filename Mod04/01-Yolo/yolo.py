...
def detect_objects(image):
    ...
    '''
    out_boxes, out_scores, out_classes = yolo_model.predict(image_data)
    '''
    print('#### predice done')
...
def show_objects(image, out_boxes, out_scores, out_classes):
    ...
    print('before ax.imshow')
    plt.imshow(img)
    print('after ax.imshow')
   # plt.show()
    #print('after plt.imshow')
